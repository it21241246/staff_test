    ...
    <div>
      ...
      <div className='container'>
        <div className='input-group mb-3'>
          ...
          <Link to="/addteacher" style={{backgroundColor: '#1C7293',color: 'white'}} className="btn btn-primary">
              Add Teacher
            </Link>
          ...
          <tbody>
            {filteredData.map((data) => (
              <tr>
                ...
                <td>
                  <Link to={`/updateteacher/${data._id}`}><button style={{backgroundColor: '#1C7293',color: 'white'}} className='btn btn-info' type='button' id='EditButton'>Edit</button></Link>
                </td>
                <td>
